    ...
    problems_solutions: [
      {
        ...
        solution: "مستخلص زهرة الآلام يعمل بسرعة على تهدئة الجهاز العصبي المركزي وتخفيف القلق، لترجع لسلامك الداخلي خلال دقائق."
      },
      {
        problem: "«مزاجي متقلب وأحس بضيقة ومو قادر أستمتع بيومي.»",
        solution: "بلسم الليمون يساعد طبيعياً على تحسين المزاج ورفع هرمونات السعادة، لتبدأ يومك بإيجابية وبدون توتر."
      },
      {
        problem: "«أحس بشد في أعصابي وعضلاتي بسبب الضغط اليومي المستمر.»",
        solution: "المغنيسيوم الموجود في القطرات معروف بقدرته السريعة على إرخاء العضلات والأعصاب المتوترة، ليعيد لجسمك راحته ومرونته."
      }
    ],
    theme: {
      from: "from-[#2e1d0f]",
