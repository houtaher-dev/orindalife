...
const REVIEWS = [
  {
    id: 1,
    text: "بصراحة، منتج الهدوء غير روتيني بالكامل. كنت أعاني من التوتر والضغط المستمر، والآن ولله الحمد أشعر بتوازن وراحة بال حقيقية. منتج يبيض الوجه، يعطيكم العافية على هذه الجودة العالية.",
    name: "نورة الكواري",
